...
namespace Projectsln.darkcomsoft.src.window
{
    /// <summary>
    ...
    /// </list>
    /// </remarks>
    public class GWindow : NativeWindow
    {
        /// <summary>
        ...
        private readonly System.Diagnostics.Stopwatch _watchRender = new System.Diagnostics.Stopwatch();
        private readonly System.Diagnostics.Stopwatch _watchUpdate = new System.Diagnostics.Stopwatch();
        ...
        public double RenderFrequency
        {
            ...
            set
            {
                ...
                {
                    Debug.Log(string.Format("Target render frequency clamped to {0}Hz.", MaxFrequency), "Window");
        ...
        /// </para>
        /// </remarks>
        public GWindow(GameWindowSettings gameWindowSettings, NativeWindowSettings nativeWindowSettings) : base(nativeWindowSettings)
        {
        ...
        public virtual void Run()
        {
            ...
            Debug.Log("Entering main loop.", "Window");
            if (IsMultiThreaded)
            {
